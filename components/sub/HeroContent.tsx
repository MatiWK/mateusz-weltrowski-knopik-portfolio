    ...
    >
        <div className='h-full w-full flex flex-col gap-5 justify-center m-auto text-start'>
            ...
            >
                ...
                <h1 className='Welcome-text text-[10px] sm:text-[13px] font-bold'>Mateusz Weltrowski-Knopik</h1>
            </motion.div>
            <motion.div
            ...
            >
                I&apos;m a Full Stack Software Developer with a Bachelor&apos;s degree and experience in website, mobile, and software development. Check out my projects and skills.
            </motion.p>
            <motion.a
            href='#projects'
